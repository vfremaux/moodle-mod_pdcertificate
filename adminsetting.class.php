 ...
 */
class mod_pdcertificate_admin_setting_upload extends admin_setting_configtext {
    ...
    function output_html($data, $query='') {
        ...
        return format_admin_setting($this, $this->visiblename,
                html_writer::link(new moodle_url('/mod/pdcertificate/upload_image.php'), get_string('upload')),
