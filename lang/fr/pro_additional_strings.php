...
require_once($CFG->dirroot.'/mod/pdcertificate/lib.php'); // to get xx_supports_feature();
if ('pro' == pdcertificate_supports_feature()) {
    include($CFG->dirroot.'/mod/pdcertificate/pro/lang/fr/pro.php');
}
